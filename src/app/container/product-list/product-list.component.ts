...
products = [
  ...
  inStockProducts = this.products.filter( prod => prod.is_in_inventory === true).length;
  outOfStockProducts = this.products.filter( prod => prod.is_in_inventory === false).length;
